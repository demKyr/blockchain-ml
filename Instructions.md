...
![](InstructionsScreenshots/media/image22.png){width="6.5in" height="0.7395833333333334in"}
...
#### 41. Wallet is now created and you can see Account 1 which has the same address as the 1^st^ account in Ganache
...
#### 47. Switch to ACCOUNTS tab in Ganache and click *Show Keys* of the 2^nd^ account
